...
class Schedule:
	...
	* while Schedule.paused is technicly an int, it is mainly used as a bool
	"""
	def __init__(self,name:str,func,time:int,args:tuple=()):
...
class TaskOwner:
	...
	def schedule(self,name:str,func,time:int,args:tuple=())->int:
		"""
	...
	def play_schedule(self,schedule):
		"""
		Unpauses a schedule
		"""
	...
	def pause_schedule(self,schedule):
		"""
		Pauses a schedule
		"""
		if not isinstance(schedule,str):
	...
	def name_set_schedule(self,schedule,name):
		"""
		Renames a schedule
		"""
		if not isinstance(schedule,str):
	...
	def update_set_schedule(self,schedule,func):
		"""
	...
	def args_set_schedule(self,schedule,args):
		"""
...
class Task:
	...
	* while Task.paused is technicly an int, it is mainly used as a bool
	"""
	def __init__(self,name:str,func,args:tuple)->None:
		if not isinstance(name,str):
			raise TypeError(f"name should be str, not {type(name).__name__}")
		if not callable(func):
			raise TypeError("func should be callable")
